...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/ffaker/ffaker/blob/master/Changelog.md", "documentation_uri" => "https://github.com/ffaker/ffaker/blob/master/REFERENCE.md" } if s.respond_to? :metadata=
